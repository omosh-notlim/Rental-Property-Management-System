...
<body>
	...
	<nav class="this-nav">
		<div class="logo">
			<i class="fa fa-home" aria-hidden="true"></i><b><span>Manyumba</span>Housing</b>
		</div>
		...
		<div class="small-container space-up">
			<div class="row">
				...
				<div class="col-2 col-2-info">
					...
					<div class="descrip">
						<p><span class="description">Description <i class="bi bi-card-text"></i></span><br>
					...
					<div class="up-bt">
						<?php
							if(isset($_SESSION['mail'])){
								echo " <a href='paymentform?HID={$row['houseID']}'> <input type='submit' name='pay' value='Rent payment'/> </a>";
							}else{
